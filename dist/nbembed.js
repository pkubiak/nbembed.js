...
document.addEventListener("DOMContentLoaded", function() {
	document.querySelectorAll("notebook").forEach(function(el) {
		...
		el.insertAdjacentHTML('beforeend', PROJECT_LINK);
